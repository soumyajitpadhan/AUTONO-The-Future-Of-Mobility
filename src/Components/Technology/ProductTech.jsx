        ...
        <div data-aos='fade-up' data-aos-delay='250' className='font-montserrat'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 lg:mb-24 py-10 px-5 sm:px-24 md:px-0'>
                <div className='relative pl-10 md:w-[330px] md:pl-20 md:mt-14 lg:w-[330px] lg:pl-20 lg:mt-24 xl:pl-48 xl:w-[550px] xl:mt-44'>
                    <h3 className='mb-5 tracking-widest xl:text-lg'>THE AUTOVATE DIGITAL PRODUCTS</h3>
                ...
                <div className='md:px-20 xl:px-48'>
                    ...
                    <p className='text-sm leading-relaxed tracking-wide xl:text-lg xl:leading-loose'>It takes both - technology and trust. Autovate's dependable electronics are built on a zero defect automotive quality mindset, which results in the high reliability. We add extensive cybersecurity expertise and a vast security system know-how.</p>
                </div>
                <div className='md:px-20 xl:px-48'>
