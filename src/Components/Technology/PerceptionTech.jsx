        ...
        <div className='bg-black text-white font-montserrat mt-36'>
            <div data-aos='fade-up' data-aos-delay='250' className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 py-10 px-5 sm:px-24 md:px-0'>
                <div className='relative pl-10 md:w-[330px] md:pl-20 md:mt-14 lg:w-[330px] lg:pl-20 lg:mt-24 xl:pl-48 xl:w-[550px] xl:mt-44'>
                    <h3 className='mb-5 tracking-widest'>THE AUTOVATE CAR</h3>
                    <p className='text-lg tracking-widest leading-relaxed xl:text-xl xl:leading-loose'>Using groundbreaking perception-enabled sensor technology, the Autovate car is a fully driverless vehicle engineered to the highest degree of precision and safety. It's autonomous driving reimagined.</p>
